  ...
  <div className="row row-cols-1 row-cols-md-3 g-4">
    <div className="col">
      <div className="card h-100">
        <img src="https://www.guvi.in/blog/wp-content/uploads/2023/11/Feature-image-Top-High-Paying-Non-Coding-Jobs-in-Data-Science.webp" className="card-img-top" alt="..."/>
        <div className="card-body">
          <h5 className="card-title">Top 10 High Paying Non-Coding Jobs in Data Science in 2024</h5>
          <p className="card-text">Are you someone who’s not interested in coding, but wants to get placed in tech<span className="read-more"><strong>Read more</strong></span></p>
        </div>
    ...
    <div className="col">
      <div className="card h-100">
        <img src="https://www.guvi.in/blog/wp-content/uploads/2023/10/Feature-image-Best-books-to-learn-data-science.webp" className="card-img-top" alt="..."/>
        <div className="card-body">
          <h5 className="card-title">Best Data Science Books to Learn in 2024</h5>
          <p className="card-text">Today, we’re going to talk about something really cool: data science. It’s all about using <span className="read-more"><strong>Read more</strong></span></p>
        </div>
        <div className="card-footer">
          <small className="text-body-secondary">20 October 2023</small>
        </div>
    ...
    <div className="col">
      <div className="card h-100">
        ...
        <div className="card-body">
          ...
          <p className="card-text">India has been making some serious waves in the world of data. Just like the<span className="read-more"><strong>Read more</strong></span></p>
        </div>
        <div className="card-footer">
          <small className="text-body-secondary">20 October 2023</small>
        </div>
